...
- [ ] Implement `mdwfWilsonForceContractionCsw0Test` as a scalar Wilson-path action-derivative check against the finite-difference harness, still without production force accumulation.
