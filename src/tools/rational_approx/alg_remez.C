...
bigfloat AlgRemez::func(const bigfloat x) {
  ...
  {
    bigfloat x_flav_1 = x + ((bigfloat) 1.0) * mass_flav_1 * mass_flav_1;     //yuanqing
  ...
  {
    bigfloat x_flav_2 = x + ((bigfloat) 1.0) * mass_flav_2 * mass_flav_2;   //yuanqing
  ...
  {
    bigfloat x_flav_3 = x + ((bigfloat) 1.0) * mass_flav_3 * mass_flav_3;     //yuanqing
  ...
  {
    bigfloat x_flav_4 = x + ((bigfloat) 1.0) * mass_flav_4 * mass_flav_4;    //yuanqing
