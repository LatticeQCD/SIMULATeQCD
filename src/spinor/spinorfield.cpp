...
#define SPINOR_INIT_PLHSN_HALF18(floatT,LO,HALOSPIN,STACKS)\
template class Spinorfield<floatT,true,LO,HALOSPIN,18,STACKS>;\

INIT_PLHSN_HALF(SPINOR_INIT_PLHSN_HALF18)
