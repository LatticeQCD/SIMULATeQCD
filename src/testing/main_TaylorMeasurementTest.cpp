...
int main(int argc, char **argv) {
    ...
    if (is_test) {
        ...
        GCOMPLEX(double) reference_results1[16] = {
            GCOMPLEX(double)(0.0), // op 0
            GCOMPLEX(double)(0.0727592, -0.000190948), // op 1
            GCOMPLEX(double)(-0.602464, 0.0012473), // op 11
            GCOMPLEX(double)(0.000188563, -0.000214152), // op 12
            GCOMPLEX(double)(0.0243022, 0.000199526), // op 13
            GCOMPLEX(double)(0.000398233, 5.24191e-05), // op 14
            GCOMPLEX(double)(-0.0350572, 0.000933468), // op 15
            GCOMPLEX(double)(0.000109375, -1.63429e-05), // op 2
            GCOMPLEX(double)(-0.00040642, 0.000370748), // op 21
            GCOMPLEX(double)(0.233341, -0.000174791), // op 22
            GCOMPLEX(double)(-6.4219e-05, -9.00177e-07), // op 23
            GCOMPLEX(double)(0.130463, -0.000368956), // op 24
            GCOMPLEX(double)(-0.000579647, -0.000647879), // op 25
            GCOMPLEX(double)(0.236625, 3.62528e-06), // op 3
            GCOMPLEX(double)(0.000120989, -6.90832e-05), // op 4
            GCOMPLEX(double)(0.129838, 0.000275378), // op 5
        };
        // results for NStacks2 (these are different for some reason, probably related to the RNG)
        GCOMPLEX(double) reference_results2[16] = {
            GCOMPLEX(double)(0.0), // op 0
            GCOMPLEX(double)(0.0729049, 0.000308857), // op 1
            GCOMPLEX(double)(-0.603425, 9.80468e-05), // op 11
            GCOMPLEX(double)(-6.17861e-05, 0.000590835), // op 12
            GCOMPLEX(double)(0.024296, -5.7674e-05), // op 13
            GCOMPLEX(double)(-0.000119477, 0.00150001), // op 14
            GCOMPLEX(double)(-0.036802, -0.00110223), // op 15
            GCOMPLEX(double)(-0.000152372, -1.39467e-05), // op 2
            GCOMPLEX(double)(0.000267956, -0.000175591), // op 21
            GCOMPLEX(double)(0.2335, -0.000496516), // op 22
            GCOMPLEX(double)(-2.80293e-05, 8.53035e-05), // op 23
            GCOMPLEX(double)(0.130606, -0.000356297), // op 24
            GCOMPLEX(double)(0.00100031, 0.000593865), // op 25
            GCOMPLEX(double)(0.236812, -2.5006e-05), // op 3
            GCOMPLEX(double)(-3.74247e-05, 9.02047e-05), // op 4
            GCOMPLEX(double)(0.129435, 6.73965e-05), // op 5
        };
