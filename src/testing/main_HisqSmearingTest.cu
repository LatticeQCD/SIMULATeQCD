...
int main(int argc, char *argv[]) {
    try {
        ...
        gaugeAccessor<PREC> gaugeAcc3 = gauge_smeared_reference.getAccessor();
        ...
        dummy.template iterateOverBulk<All, HaloDepth>(
                count_faulty_links<PREC, true, HaloDepth, R18>(gauge_Lv2, gauge_smeared_reference_device));
