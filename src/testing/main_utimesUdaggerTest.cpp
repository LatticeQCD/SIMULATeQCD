...
struct CalcTrUtimesUdagger{
    ...
    CalcTrUtimesUdagger(Gaugefield<floatT,true,HaloDepth> &gauge) : SU3Accessor(gauge.getAccessor()){}
    ...
    __device__ __host__ floatT operator()(gSite site) {
        ...
        for (int mu = 0; mu < 4; mu++) {
            ...
            result+=tr_d(SU3Accessor.getLink(siteMu)*dagger(SU3Accessor.getLink(siteMu)));
        }
        return result/3;
    }
};
