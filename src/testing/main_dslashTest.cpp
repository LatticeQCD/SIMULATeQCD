...
bool test_dslash(CommunicationBase &commBase){
    ...
    Vect3<floatT> OE_vec_0 = Vect3<floatT>(COMPLEX(floatT)(2.3391,0.133572),COMPLEX(floatT)(-1.2575,-3.71507),
        COMPLEX(floatT)(0.0448819,-1.03748));
    Vect3<floatT> OE_vec_512 = Vect3<floatT>(COMPLEX(floatT)(-1.41934,0.264733),COMPLEX(floatT)(-1.63475,1.55185),
        COMPLEX(floatT)(-1.71302,-2.05072));
    Vect3<floatT> OE_vec_697 = Vect3<floatT>(COMPLEX(floatT)(1.10125,-0.909113),COMPLEX(floatT)(-1.92929,-0.893694),
        COMPLEX(floatT)(-1.21505,-0.491814));
    Vect3<floatT> OE_vec_1023 = Vect3<floatT>(COMPLEX(floatT)(-1.01115,-0.838747),COMPLEX(floatT)(-1.45297,-0.0797096),
        COMPLEX(floatT)(-0.0330309,1.81019));

    Vect3<floatT> EO_vec_0 = Vect3<floatT>(COMPLEX(floatT)(0.479281,-0.210938),COMPLEX(floatT)(-2.60014,-1.10176),
        COMPLEX(floatT)(0.417858,-1.59543));
    Vect3<floatT> EO_vec_319 = Vect3<floatT>(COMPLEX(floatT)(0.877146,0.391793),COMPLEX(floatT)(-0.177829,-0.995388),
        COMPLEX(floatT)(-1.37693,0.670404));
    Vect3<floatT> EO_vec_550 = Vect3<floatT>(COMPLEX(floatT)(-0.102483,-1.74452),COMPLEX(floatT)(1.02125,-2.43817),
        COMPLEX(floatT)(1.1127,0.309778));
    Vect3<floatT> EO_vec_1023 = Vect3<floatT>(COMPLEX(floatT)(1.25156,-1.10202),COMPLEX(floatT)(0.190079,-0.295352),
        COMPLEX(floatT)(0.273009,-0.809811));
