...
public:
    ...
    virtual void applyMdaggM_half(SpinorRHS_t &, SpinorRHS_t &, bool update = true) = 0;
    virtual void applyMdaggM_single(SpinorRHS_t &, SpinorRHS_t &, bool update = true) = 0;
};
...
public:
    ...
    virtual void applyMdaggM_half(SpinorRHS_t &spinorOut, SpinorRHS_t &spinorIn, bool update = false);
    virtual void applyMdaggM_single(SpinorRHS_t &spinorOut, SpinorRHS_t &spinorIn, bool update = false);
