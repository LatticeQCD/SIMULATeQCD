...
template<class floatT, bool onDevice, size_t HaloDepth, CompressionType comp = R14, CompressionType compLvl1 = R18, CompressionType compLvl2 = R18, CompressionType compNaik = U3R14>
 ...
 public:
 HisqSmearing(Gaugefield<floatT, onDevice, HaloDepth, comp> &gauge_base,
 ...
 : _gauge_base(gauge_base), _gauge_lvl1(gauge_base.getComm(), "SHARED_GAUGENAIK" ),
 _gauge_lvl2(gauge_lvl2), _gauge_naik(gauge_naik), _dummy(gauge_base.getComm(), "SHARED_DUMMY"),
   _Lvl2(getLevel2Params<floatT>(naik_epsilon)),
 staple3_lvl1(_gauge_base.getAccessor()),
 ...
 staple3_lvl2(_gauge_lvl1.getAccessor()),
