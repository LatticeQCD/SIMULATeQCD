...
struct PloopCorrOffAxisKernel : CorrelatorTools<floatT, true, HaloDepth> {
    ...
    __device__ __host__ void operator()(size_t dindex) {
        ...
        for(int tz=0;tz<(this->Nz);tz++) {
            ...
            _ploop.getValue<SU3<floatT>>(m ,polm);
            _ploop.getValue<SU3<floatT>>(n1,poln);
            plc_contrib(polm,poln,avg,sin,oct);

            _ploop.getValue<SU3<floatT>>(n2,poln);
            plc_contrib(polm,poln,avg,sin,oct);

            _ploop.getValue<SU3<floatT>>(n3,poln);
            plc_contrib(polm,poln,avg,sin,oct);

            _ploop.getValue<SU3<floatT>>(n4,poln);
            plc_contrib(polm,poln,avg,sin,oct);
        }
        avg /= ((this->vol3)*36.);
        sin /= ((this->vol3)*12.);
...
void PolyakovLoopCorrelator<floatT,onDevice,HaloDepth>::PLCtoArrays(std::vector<floatT> &vec_plca,
    ...
    /// This line tells us PtrPloopGPU refers to an array of SU3<floatT> with a size of global spacelike volume.
    PtrPloopGPU->template adjustSize<SU3<floatT>>(this->vol3);
    ...
    if (fastCorr) {
        ...
        iterateFunctorNoReturn<onDevice>(
                RestrictedOffAxisKernel<floatT,HaloDepth,SU3<floatT>,floatT,polCorrAVG<floatT>>(_ploopGPU,_ploopGPU,_plcaoffGPU),
                passReadIndex,this->pvol3);
        iterateFunctorNoReturn<onDevice>(
                RestrictedOnAxisKernel<floatT,HaloDepth,SU3<floatT>,floatT,polCorrAVG<floatT>>(_ploopGPU,_ploopGPU,_plcaoffGPU,_plcaonGPU),
                passReadIndex,this->RSonmax);
        iterateFunctorNoReturn<onDevice>(
                RestrictedOffAxisKernel<floatT,HaloDepth,SU3<floatT>,floatT,polCorrSIN<floatT>>(_ploopGPU,_ploopGPU,_plc1offGPU),
                passReadIndex,this->pvol3);
        iterateFunctorNoReturn<onDevice>(
                RestrictedOnAxisKernel<floatT,HaloDepth,SU3<floatT>,floatT,polCorrSIN<floatT>>(_ploopGPU,_ploopGPU,_plc1offGPU,_plc1onGPU),
                passReadIndex,this->RSonmax);
        iterateFunctorNoReturn<onDevice>(
                RestrictedOffAxisKernel<floatT,HaloDepth,SU3<floatT>,floatT,polCorrOCT<floatT>>(_ploopGPU,_ploopGPU,_plc8offGPU),
                passReadIndex,this->pvol3);
        iterateFunctorNoReturn<onDevice>(
                RestrictedOnAxisKernel<floatT,HaloDepth,SU3<floatT>,floatT,polCorrOCT<floatT>>(_ploopGPU,_ploopGPU,_plc8offGPU,_plc8onGPU),
                passReadIndex,this->RSonmax);
    }
