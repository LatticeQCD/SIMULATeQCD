...
COMPLEX(floatT) WilsonLineCorrelatorMultiGPU<floatT,HaloDepth,stacks>::gDotAlongXY( Gaugefield<floatT,true,HaloDepth> &gauge ,int shiftx, int shifty,  LatticeContainer<true,COMPLEX(floatT)> &redBase){
...
template<class floatT, size_t HaloDepth,int stacks>
COMPLEX(floatT) WilsonLineCorrelatorMultiGPU<floatT,HaloDepth,stacks>::gDotAlongXYFull( Gaugefield<floatT,true,HaloDepth> &gauge ,int shiftx, int shifty,  LatticeContainer<true,COMPLEX(floatT)> &redBase){
