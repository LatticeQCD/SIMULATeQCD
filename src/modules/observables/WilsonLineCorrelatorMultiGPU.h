...
struct WilsonLoop{
    ...
    MemoryAccessor _redBase;
    gaugeAccessor<floatT> _gaugeIn;
    gaugeAccessor<floatT> _gaugeInX;
    int _wlt;
...
///////////////x direction
	      GSU3<floatT> su3Temp = _gaugeIn.getLink(GInd::getSiteMu(GInd::getSiteFull(coords.x,coords.y, coords.z, (size_t)(tt)),0));
	      GSU3<floatT> su3TempXend   = gsu3_one<floatT>();
	      GSU3<floatT> su3TempXstart = gsu3_one<floatT>();
...
///////////////y direction
              su3TempXend   = gsu3_one<floatT>();
              su3TempXstart = gsu3_one<floatT>();
