...
struct ResetWilsonLineKernel{
    ...
    ResetWilsonLineKernel(Gaugefield<floatT,onDevice,HaloDepth> &_gauge,
            ...
            SU3Accessor(_gauge.getAccessor()), _wline(wline) {}
    __device__ __host__ void operator()(gSite site) {

        int id = site.isite;
        _wline.setValue<SU3<floatT>>(id, su3_one<floatT>());
...
struct MeasureWilsonLineKernel{
    ...
    MeasureWilsonLineKernel(Gaugefield<floatT,onDevice,HaloDepth> &_gauge,
            ...
            SU3Accessor(_gauge.getAccessor()), _wline(wline), _tau(tau), _dtau(dtau) {}
    __device__ __host__ void operator()(gSite site) {
        ...
        int id = site.isite;
        SU3<floatT> temp;
        _wline.getValue<SU3<floatT>>(id, temp);
        temp *= SU3Accessor.getLink(GInd::getSiteMu(newSite, 3));
        _wline.setValue<SU3<floatT>>(id,temp);
    }
};
...
void WilsonLineCorrelator<floatT,onDevice,HaloDepth>::WLCtoArrays(std::vector<floatT> &vec_wlca_full,
    ...
    for (int tau=0;tau<Nt;tau++)
    {
        ...
        PtrPloopGPU->template adjustSize<SU3<floatT>>(GInd::getLatData().globvol3);
        ...
        for (int dtau=0;dtau<Nt;dtau++)
        {
            ...
            if (fastCorr) {
                ...
                iterateFunctorNoReturn<onDevice>(
                        RestrictedOffAxisKernel<floatT,HaloDepth,SU3<floatT>,floatT,polCorrAVG<floatT>>(_wlineGPU,_wlineGPU,_wlcaoffGPU),
                        passReadIndex,this->pvol3);
                iterateFunctorNoReturn<onDevice>(
                        RestrictedOnAxisKernel<floatT,HaloDepth,SU3<floatT>,floatT,polCorrAVG<floatT>>(_wlineGPU,_wlineGPU,_wlcaoffGPU,_wlcaonGPU),
                        passReadIndex,this->RSonmax);
                iterateFunctorNoReturn<onDevice>(
                        RestrictedOffAxisKernel<floatT,HaloDepth,SU3<floatT>,floatT,polCorrSIN<floatT>>(_wlineGPU,_wlineGPU,_wlc1offGPU),
                        passReadIndex,this->pvol3);
                iterateFunctorNoReturn<onDevice>(
                        RestrictedOnAxisKernel<floatT,HaloDepth,SU3<floatT>,floatT,polCorrSIN<floatT>>(_wlineGPU,_wlineGPU,_wlc1offGPU,_wlc1onGPU),
                        passReadIndex,this->RSonmax);
                iterateFunctorNoReturn<onDevice>(
                        RestrictedOffAxisKernel<floatT,HaloDepth,SU3<floatT>,floatT,polCorrOCT<floatT>>(_wlineGPU,_wlineGPU,_wlc8offGPU),
                        passReadIndex,this->pvol3);
                iterateFunctorNoReturn<onDevice>(
                        RestrictedOnAxisKernel<floatT,HaloDepth,SU3<floatT>,floatT,polCorrOCT<floatT>>(_wlineGPU,_wlineGPU,_wlc8offGPU,_wlc8onGPU),
                        passReadIndex,this->RSonmax);
            }
