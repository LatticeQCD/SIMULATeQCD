...
struct emTensorElementsE {
    ...
    emTensorElementsE(gaugeAccessor<floatT> gAcc, MemoryAccessor sub_E_gpu) : gAcc(gAcc), sub_E_gpu(sub_E_gpu), FT(gAcc) {}
...
struct Ftau2PlusMinusFsigma2Elements {
    ...
    __device__ __host__ inline GCOMPLEX(floatT) operator()(gSite site) {
        ...
        return GCOMPLEX(floatT)(FtauSquare+FsigmaSquare, FtauSquare-FsigmaSquare);
    }
};
...
struct emTensorElementsU {
    ...
    emTensorElementsU(gaugeAccessor<floatT> gAcc, MemoryAccessor sub_E_gpu, MemoryAccessor sub_U_gpu) : gAcc(gAcc), sub_E_gpu(sub_E_gpu), sub_U_gpu(sub_U_gpu), FT(gAcc) {}
