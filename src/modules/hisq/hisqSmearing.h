...
public:
    staple(SU3Accessor<floatT, comp> gAccIn) : _gAcc(gAccIn) {}
...
struct U3ProjectStruct{
    SU3Accessor<floatT,comp> gauge_acc;
    U3ProjectStruct(SU3Accessor<floatT,comp> gaugeAcc_in): gauge_acc(gaugeAcc_in){}
