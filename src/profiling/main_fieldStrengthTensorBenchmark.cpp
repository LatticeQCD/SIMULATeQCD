...
struct FieldStrengthTensorTemporalKernel{
    ...
    FieldStrengthTensorTemporalKernel(Gaugefield<floatT,onDevice,HaloDepth> &gauge) : SU3Accessor(gauge.getAccessor()), FT(gauge.getAccessor()) {}
    __device__ __host__ SU3<floatT> operator()(gSite site) {
...
struct FieldStrengthTensorSpatialKernel{
    ...
    FieldStrengthTensorSpatialKernel(Gaugefield<floatT,onDevice,HaloDepth> &gauge) : SU3Accessor(gauge.getAccessor()), FT(gauge.getAccessor()) { }
    __device__ __host__ SU3<floatT> operator()(gSite site) {
        typedef GIndexer<All,HaloDepth> GInd;
...
template<class floatT, bool onDevice, size_t HaloDepth>
SU3<floatT> getFmunu_spatial(Gaugefield<floatT,true, HaloDepth> &gauge, LatticeContainer<true,SU3<floatT>> &redBase){
...
template<class floatT, bool onDevice, size_t HaloDepth>
SU3<floatT> getFmunu_temporal(Gaugefield<floatT,true, HaloDepth> &gauge, LatticeContainer<true,SU3<floatT>> &redBase){
...
int main(int argc, char *argv[]) {
    ...
    LatticeContainer<true,SU3<PREC>> redBase(commBase);
