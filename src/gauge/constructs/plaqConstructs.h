...
__host__ __device__ SU3<floatT> inline Plaq_P(SU3Accessor<floatT,comp> gAcc, gSite site, int mu, int nu) {
...
template<class floatT,size_t HaloDepth,CompressionType comp>
__host__ __device__ SU3<floatT> inline Plaq_Q(SU3Accessor<floatT,comp> gAcc, gSite site, int mu, int nu) {
    typedef GIndexer<All,HaloDepth> GInd;
...
template<class floatT,size_t HaloDepth,CompressionType comp>
__host__ __device__ SU3<floatT> inline Plaq_R(SU3Accessor<floatT,comp> gAcc, gSite site, int mu, int nu) {
    typedef GIndexer<All,HaloDepth> GInd;
...
template<class floatT,size_t HaloDepth,CompressionType comp>
__host__ __device__ SU3<floatT> inline Plaq_S(SU3Accessor<floatT,comp> gAcc, gSite site, int mu, int nu) {
    typedef GIndexer<All,HaloDepth> GInd;
