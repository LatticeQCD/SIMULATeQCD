...
template<class floatT,size_t HaloDepth>
__device__ GSU3<floatT> inline Rect_Q(gaugeAccessor<floatT> gAcc, gSite site, int mu, int nu) {
    typedef GIndexer<All,HaloDepth> GInd;
...
template<class floatT,size_t HaloDepth>
__device__ GSU3<floatT> inline Rect_S(gaugeAccessor<floatT> gAcc, gSite site, int mu, int nu) {
    typedef GIndexer<All,HaloDepth> GInd;
...
template<class floatT,size_t HaloDepth>
__device__ GSU3<floatT> inline Rect_R(gaugeAccessor<floatT> gAcc, gSite site, int mu, int nu) {
    typedef GIndexer<All,HaloDepth> GInd;
