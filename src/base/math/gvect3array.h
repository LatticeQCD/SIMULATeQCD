...
struct gVect3arrayAcc : public GeneralAccessor<GCOMPLEX(floatT), 3 > {
    ...
    HOST_DEVICE explicit gVect3arrayAcc(GCOMPLEX(floatT) *elementsBase, size_t object_count)
    ...
    HOST_DEVICE inline gVect3<floatT_compute> getElement(const gSite &site) const {
    ...
    template<class floatT_compute=floatT>
    HOST_DEVICE inline void setElement(const gSite &site, const gVect3<floatT_compute> &vec) {
    ...
    template<class floatT_compute=floatT>
    HOST_DEVICE inline gVect3<floatT_compute> getElement(const gSiteStack &site) const {
        gVect3<floatT> ret(
    ...
    template<class floatT_compute=floatT>
    HOST_DEVICE inline void setElement(const gSiteStack &site, const gVect3<floatT_compute> &vec) {
    ...
    HOST_DEVICE inline void setEntriesComm(gVect3arrayAcc<floatT> &src_acc,
    ...
    HOST_DEVICE inline size_t getIndexComm(size_t isiteFull, size_t stack) const {
    ...
    HOST_DEVICE inline gVect3<floatT_compute> getElementComm(size_t isiteFull, size_t stack) const {
        gSiteStack site = GIndexer<LatLayout, HaloDepth>::getSiteStackFull(isiteFull, stack);
        return getElement<floatT_compute>(site);
    }

    template<class floatT_compute=floatT>
    HOST_DEVICE inline void setElementComm(size_t isiteFull, size_t stack, const gVect3<floatT_compute> &vec) {
        gSiteStack site;
    ...
    template<class floatT_compute=floatT>
    HOST_DEVICE inline gVect3<floatT_compute> operator()(const gSite &site) const {
        return this->getElement<floatT_compute>(site);
    };

    template<class floatT_compute=floatT>
    HOST_DEVICE inline gVect3<floatT_compute> operator()(const gSiteStack &site) const {
        return this->getElement<floatT_compute>(site);
    };
};
