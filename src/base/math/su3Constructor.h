...
struct GaugeConstructor : public GeneralAccessor<COMPLEX(floatT_memory), EntryCount<comp>::count> {
    explicit GaugeConstructor(COMPLEX(floatT_memory) *const elements[EntryCount<comp>::count])
            : GeneralAccessor<COMPLEX(floatT_memory), EntryCount<comp>::count >(elements) {
    }
    /// Constructor for one memory chunk, where all entries are separated by object_count
    __host__ __device__ explicit GaugeConstructor(COMPLEX(floatT_memory) *elementsBase, size_t object_count)
            : GeneralAccessor<COMPLEX(floatT_memory), EntryCount<comp>::count >(elementsBase, object_count){
    }
    explicit GaugeConstructor() : GeneralAccessor<COMPLEX(floatT_memory), EntryCount<comp>::count >(){ }
};

template<class floatT_memory>
struct GaugeConstructor<floatT_memory, R18> : public GeneralAccessor<COMPLEX(
        floatT_memory), EntryCount<R18>::count> {

    explicit GaugeConstructor(COMPLEX(floatT_memory) *const elements[EntryCount<R18>::count])
            : GeneralAccessor<COMPLEX(floatT_memory), EntryCount<R18>::count>(elements) {}

    __host__ __device__ explicit GaugeConstructor(COMPLEX(floatT_memory) *elementsBase, size_t object_count)
            : GeneralAccessor<COMPLEX(floatT_memory), EntryCount<R18>::count >(elementsBase, object_count) {}

    explicit GaugeConstructor() : GeneralAccessor<COMPLEX(floatT_memory), EntryCount<R18>::count>() {}
    ...
    __host__ __device__ inline void construct(const gSiteMu& idx, const SU3<floatT_memory> &mat) {
    ...
    __host__ __device__ inline SU3<floatT_memory> reconstruct(const gSiteMu& idx) const {
        SU3<floatT_memory> ret(
    ...
    __host__ __device__ inline SU3<floatT_memory> reconstructDagger(const gSiteMu& idx) const {
        return SU3<floatT_memory>(conj(this->template getElementEntry<e00>(idx.indexMuFull)),
...
template<class floatT_memory>
struct GaugeConstructor<floatT_memory, U3R14> : public GeneralAccessor<COMPLEX(
        floatT_memory), EntryCount<U3R14>::count > {

    explicit GaugeConstructor(COMPLEX(floatT_memory) *const elements[EntryCount<U3R14>::count])
            : GeneralAccessor<COMPLEX(floatT_memory), EntryCount<U3R14>::count >(elements) {
    }
    __host__ __device__ explicit GaugeConstructor(COMPLEX(floatT_memory) *elementsBase, size_t object_count)
            : GeneralAccessor<COMPLEX(floatT_memory), EntryCount<U3R14>::count >(elementsBase, object_count){
    }
    explicit GaugeConstructor() : GeneralAccessor<COMPLEX(floatT_memory), EntryCount<U3R14>::count >(){ }
    ...
    __host__ __device__ inline SU3<floatT_memory> reconstruct(const gSiteMu& idx) const {
        ...
        COMPLEX(floatT_memory) phase = this->template getElementEntry<e20>(idx.indexMuFull);
    ...
    __host__ __device__ inline SU3<floatT_memory> reconstructDagger(const gSiteMu& idx) const {
        SU3<floatT_memory> tmp = SU3<floatT_memory>(
                conj(this->template getElementEntry<e00>(idx.indexMuFull)),
                conj(this->template getElementEntry<e10>(idx.indexMuFull)),
                COMPLEX(floatT_memory)(0., 0.),
                conj(this->template getElementEntry<e01>(idx.indexMuFull)),
                conj(this->template getElementEntry<e11>(idx.indexMuFull)),
                COMPLEX(floatT_memory)(0., 0.),
                conj(this->template getElementEntry<e02>(idx.indexMuFull)),
...
template<class floatT_memory>
struct GaugeConstructor<floatT_memory, R14> : public GeneralAccessor<COMPLEX(
        floatT_memory), EntryCount<R14>::count > {

    explicit GaugeConstructor(COMPLEX(floatT_memory) *const elements[EntryCount<R14>::count])
            : GeneralAccessor<COMPLEX(floatT_memory), EntryCount<R14>::count >(elements) {
    }
    __host__ __device__ explicit GaugeConstructor(COMPLEX(floatT_memory) *elementsBase, size_t object_count)
            : GeneralAccessor<COMPLEX(floatT_memory), EntryCount<R14>::count >(elementsBase, object_count) {
    }
    explicit GaugeConstructor() : GeneralAccessor<COMPLEX(floatT_memory), EntryCount<R14>::count>() { }
...
template<class floatT_memory>
struct GaugeConstructor<floatT_memory, R12> : public GeneralAccessor<COMPLEX(floatT_memory), EntryCount<R12>::count> {

    explicit GaugeConstructor(COMPLEX(floatT_memory) *const elements[EntryCount<R12>::count])
            : GeneralAccessor<COMPLEX(floatT_memory), EntryCount<R12>::count >(elements) {
    }
    __host__ __device__ explicit GaugeConstructor(COMPLEX(floatT_memory) *elementsBase, size_t object_count)
            : GeneralAccessor<COMPLEX(floatT_memory), EntryCount<R12>::count>(elementsBase, object_count) {
    }
    explicit GaugeConstructor() : GeneralAccessor<COMPLEX(floatT_memory), EntryCount<R12>::count>() { }
...
template<class floatT_memory>
struct GaugeConstructor<floatT_memory, STAGG_R12> : public GeneralAccessor<COMPLEX(
...
public:
    ...
    explicit GaugeConstructor(COMPLEX(floatT_memory) *const elements[EntryCount<STAGG_R12>::count])
            : GeneralAccessor<COMPLEX(floatT_memory), EntryCount<STAGG_R12>::count>(elements) {
        throw std::runtime_error(stdLogger.fatal("STAGG_R12 should not be used at the moment"));
    }
    __host__ __device__ explicit GaugeConstructor(COMPLEX(floatT_memory) *elementsBase, size_t object_count)
            : GeneralAccessor<COMPLEX(floatT_memory), EntryCount<STAGG_R12>::count >(elementsBase, object_count) {
    }
    explicit GaugeConstructor() : GeneralAccessor<COMPLEX(floatT_memory), EntryCount<STAGG_R12>::count>() { }
