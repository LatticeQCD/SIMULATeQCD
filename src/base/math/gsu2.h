...
public:
  ...
  HOST_DEVICE GSU2(GCOMPLEX(floatT) e11, GCOMPLEX(floatT) e12) : _e11(e11), _e12(e12) {}


  HOST_DEVICE  friend GSU2 operator+(const GSU2 &x,const GSU2 &y) {
  ...
  HOST_DEVICE  friend GSU2 operator*(const GSU2 &x,const GCOMPLEX(floatT)  &y) {
    return GSU2 (x._e11*y,x._e12*y);
  }

  HOST_DEVICE  friend GSU2 operator*(const GCOMPLEX(floatT)  &x,const GSU2 &y) {
    return GSU2 (x*y._e11,x*y._e12);
  }

  HOST_DEVICE  friend GSU2 operator*(const GSU2 &x,const floatT  &y) {
    return GSU2 (x._e11*y,x._e12*y);
  }

  HOST_DEVICE  friend GSU2 operator*(const floatT  &x,const GSU2 &y) {
    return GSU2 (x*y._e11,x*y._e12);
  }
  ...
  HOST_DEVICE  GSU2 &operator =(const GSU2 &y) {
    _e11=y._e11;
    _e12=y._e12;
    return *this;
  }
  ...
  HOST_DEVICE  GSU2 &operator*=(const GCOMPLEX(floatT) &y) {
    _e11*=y;
    _e12*=y;
    return *this;
  }
  HOST_DEVICE  GSU2 &operator*=(const floatT &y) {
    *this=*this*y;
    return *this;
  }
  HOST_DEVICE  GSU2 &operator/=(const floatT &y) {
  ...
  HOST_DEVICE  floatT tr2() {
    return( real(_e11) );
  }

  HOST_DEVICE  GCOMPLEX(floatT) det() {
    return( real(_e11) );
  }

  HOST_DEVICE  void unitarize() {
    floatT res;
  ...
  HOST_DEVICE  floatT norm2() const {
...
template<typename floatT>
HOST_DEVICE inline GSU2<floatT> dagger(const GSU2<floatT> &x) {
    GSU2<floatT> tmp;
...
template<typename floatT>
HOST_DEVICE  inline floatT norm2(const GSU2<floatT> &x) {
  return (  real(x._e11)*real(x._e11) + real(x._e12)*real(x._e12)
	        + imag(x._e11)*imag(x._e11) + imag(x._e12)*imag(x._e12) );
}

template<typename floatT>
HOST_DEVICE inline  GSU2<floatT> sub12 (const GSU3<floatT> &u, const GSU3<floatT> &v) {
...
template<typename floatT>
HOST_DEVICE inline GSU2<floatT> sub13(const GSU3<floatT> &u, const GSU3<floatT> &v) {
  GCOMPLEX(floatT)  r00,r01,r10,r11;
...
template<typename floatT>
HOST_DEVICE inline GSU2<floatT> sub23(const GSU3<floatT> &u, const GSU3<floatT> &v) {
  GCOMPLEX(floatT)  r00,r01,r10,r11;
...
template<typename floatT>
HOST_DEVICE inline GSU3<floatT> sub12(const GSU2<floatT> &u, 
					      const GSU3<floatT> &v) {
...
template<typename floatT>
HOST_DEVICE inline GSU3<floatT> sub13(const GSU2<floatT> &u, const GSU3<floatT> &v) {
...
template<typename floatT>
HOST_DEVICE inline GSU3<floatT> sub23(const GSU2<floatT> &u, const GSU3<floatT> &v) {
...
template<typename floatT>
HOST_DEVICE  inline floatT realtrace(const GSU3<floatT> &x) {
