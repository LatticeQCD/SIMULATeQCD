...
public:
  ...
  __host__ __device__ GSU2() { };
  GCOMPLEX(floatT) _e11,_e12;
  __host__ __device__ GSU2(GCOMPLEX(floatT) e11, GCOMPLEX(floatT) e12) : _e11(e11), _e12(e12) {}


  __host__ __device__  friend GSU2 operator+(const GSU2 &x,const GSU2 &y) {
  ...
  __host__ __device__  friend GSU2 operator*(const GSU2 &x,const GCOMPLEX(floatT)  &y) {
    return GSU2 (x._e11*y,x._e12*y);
  }

  __host__ __device__  friend GSU2 operator*(const GCOMPLEX(floatT)  &x,const GSU2 &y) {
    return GSU2 (x*y._e11,x*y._e12);
  }

  __host__ __device__  friend GSU2 operator*(const GSU2 &x,const floatT  &y) {
    return GSU2 (x._e11*y,x._e12*y);
  }

  __host__ __device__  friend GSU2 operator*(const floatT  &x,const GSU2 &y) {
    return GSU2 (x*y._e11,x*y._e12);
  }
  ...
  __host__ __device__  GSU2 &operator =(const GSU2 &y) {
    _e11=y._e11;
    _e12=y._e12;
    return *this;
  }
  ...
  __host__ __device__  GSU2 &operator*=(const GCOMPLEX(floatT) &y) {
    _e11*=y;
    _e12*=y;
    return *this;
  }
  __host__ __device__  GSU2 &operator*=(const floatT &y) {
    *this=*this*y;
    return *this;
  }
  __host__ __device__  GSU2 &operator/=(const floatT &y) {
  ...
  __host__ __device__  floatT tr2() {
    return( real(_e11) );
  }

  __host__ __device__  GCOMPLEX(floatT) det() {
    return( real(_e11) );
  }

  __host__ __device__  void unitarize() {
    floatT res;
  ...
  __host__ __device__  GSU2 dagger() const {
    GSU2 tmp;
  ...
  __host__ __device__  floatT norm2() const {
...
template<typename floatT>
__host__ __device__ inline GSU2<floatT> dagger(const GSU2<floatT> &x) {
    GSU2<floatT> tmp;
...
template<typename floatT>
__host__ __device__  inline floatT norm2(const GSU2<floatT> &x) {
  return (  real(x._e11)*real(x._e11) + real(x._e12)*real(x._e12)
	        + imag(x._e11)*imag(x._e11) + imag(x._e12)*imag(x._e12) );
}

template<typename floatT>
__host__ __device__ inline  GSU2<floatT> sub12 (const GSU3<floatT> &u, const GSU3<floatT> &v) {
...
template<typename floatT>
__host__ __device__ inline GSU2<floatT> sub13(const GSU3<floatT> &u, const GSU3<floatT> &v) {
  GCOMPLEX(floatT)  r00,r01,r10,r11;
...
template<typename floatT>
__host__ __device__ inline GSU2<floatT> sub23(const GSU3<floatT> &u, const GSU3<floatT> &v) {
  GCOMPLEX(floatT)  r00,r01,r10,r11;
...
template<typename floatT>
__host__ __device__ inline GSU3<floatT> sub12(const GSU2<floatT> &u,
					      const GSU3<floatT> &v) {
...
template<typename floatT>
__host__ __device__ inline GSU3<floatT> sub13(const GSU2<floatT> &u, const GSU3<floatT> &v) {
...
template<typename floatT>
__host__ __device__ inline GSU3<floatT> sub23(const GSU2<floatT> &u, const GSU3<floatT> &v) {
...
template<typename floatT>
__host__ __device__  inline floatT realtrace(const GSU3<floatT> &x) {
